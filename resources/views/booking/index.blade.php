@extends('layouts.app_tiny', ['title' => 'Data Booking Pelanggan'])
            ...
            <table class="table table-striped" id="menuTable">
                ...
                <div class="row mb-3 mt-3">
                    ...
                    <a href="/booking?status=Tunggu"
                        class="btn btn-primary{{ request('status') == 'Tunggu' ? 'active' : '' }}"
                        style="margin-right: 12px">Tunggu</a>
                    <a href="/booking?status=Disetujui"
                        class="btn btn-primary{{ request('status') == 'Disetujui' ? 'active' : '' }}"
                        style="margin-right: 12px">Disetujui</a>
                    <a href="/booking?status=Ditolak"
                        class="btn btn-primary{{ request('status') == 'Ditolak' ? 'active' : '' }}"
                    ...
                    @foreach ($booking as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#bookingshow{{ $item->id }}" class="btn btn-info btn-sm" data-toggle="modal"
